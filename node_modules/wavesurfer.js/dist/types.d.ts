...
declare const dom_isHTMLElement: typeof isHTMLElement;
declare namespace dom {
  export {
    dom_createElement as createElement,
    createElement as default,
    dom_isHTMLElement as isHTMLElement,
  };
}
...
declare class Renderer extends EventEmitter<RendererEvents> {
    ...
    private containerInlinePadding;
    constructor(options: WaveSurferOptions, audioElement?: HTMLElement);
    private parentFromOptionsContainer;
    private onClickWrapper;
    private onDblClickWrapper;
    private initEvents;
    private onContainerResize;
    private initDrag;
    private calculateInlinePadding;
    private initHtml;
...
export type { Signal, WaveSurferActions, WaveSurferEvents, WaveSurferOptions, WaveSurferState, WritableSignal };
